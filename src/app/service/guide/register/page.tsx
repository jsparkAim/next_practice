                ...
                <div className="overflow-x-auto">
                    ...
                    <div className="overflow-hidden border rounded-lg">
                        ...
                        <tbody className="divide-y divide-gray-200 ">
                            ...
                            <td className="px-6 py-4 text-sm text-gray-800 whitespace-nowrap">
                                <div className="flex items-center">
                                    <input {...register("expsr_tf")} value="N" type="radio" id="option1" name="expsr_tf" className="" onChange={()=> setExpsrTf('F')}/>
                                    <label htmlFor="option1" className="flex items-center cursor-pointer ml-2">
                                            N
                                    </label>
                                    <input {...register("expsr_tf")} value="Y" type="radio" id="option2" name="expsr_tf" className="ml-3" onChange={()=> setExpsrTf('T')} />
                            ...
                            <td className="px-6 py-4 text-sm font-medium text-gray-800 whitespace-nowrap bg-slate-300">
                                ...
                                <td className="px-6 py-4 text-sm text-gray-800 whitespace-nowrap">
                                    <div className="flex items-center">
                                        <input type="radio" {...register("expsr_end_dt_stng_tf")} value="Y" id="expsr_true" name="expsr_end_dt_stng_tf" className="" onChange={()=> setExpsrEndDtStngTf('T')} checked={expsr_end_dt_stng_tf === 'T'}/>
                                        <label htmlFor="option1" className="flex items-center cursor-pointer ml-2">
                                                종료일 설정
                                        </label>
                                    </div>
                                    <div>
                                        <input type="radio" {...register("expsr_end_dt_stng_tf")} value="N" id="expsr_false" name="expsr_end_dt_stng_tf" className="" onChange={()=> setExpsrEndDtStngTf('F')} checked={expsr_end_dt_stng_tf === 'F'}/>
                        ...
                        <div>
                            ...
                            <button onClick={ serviceGuidelist } className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                                목록
                            </button>
                        </div>
                        </form>
